...
def radon_op(img_size=[128, 128], sino_size=[256, 1024]):
    xx=64
    ...
    detector_partition = odl.uniform_partition(-5,5, detectors)
    geometry = odl.tomo.FanFlatGeometry(angle_partition, detector_partition,src_radius=2, det_radius=2)
